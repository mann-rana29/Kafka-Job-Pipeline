package main.workerservice.services;
...
public class JobProcessingService {
    ...
    public void processAndRoute(JobEvent event, Acknowledgment ack){
        ...
        try{
            ...
            log.error("Failed processing the job Id : {}. ", event.getJobId(),e);
        }
    }
